    ...
    template: `
        <div class="form-inline d-flex justify-content-center">
            ...
            <div class= "news">
                <h2>News</h2>
                <ul class= "news__list">
                    <li v-for="article in articles" class="news__item"> <h5>{{ article.title }}</h5>
                    <br>
                    <img v-bind:src= "article.urlToImage" alt= "News Headline Photo" height= "200" width="320">
                    <br>
                    {{article.description}}
                    </li>
                </ul>
...
const Home = Vue.component('home', {
    ...
    data: function() {
        return {
            welcome: 'Hello World! Welcome to Vue Js.'
        }
    }
